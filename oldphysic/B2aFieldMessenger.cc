...
B2aFieldMessenger::B2aFieldMessenger(B2aField* fField)
 : G4UImessenger(),
...
B2aFieldMessenger::~B2aFieldMessenger()
{
  delete fStepperCmd;
  delete fElFieldCmd;
  delete fMinStepCmd;
...
void B2aFieldMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
