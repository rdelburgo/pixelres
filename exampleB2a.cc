...
B2aDetectorConstruction* detconst= new B2aDetectorConstruction();
/** 
G4PhysListFactory* physListFactory = new G4PhysListFactory(); 
G4VUserPhysicsList *physicsList =  physListFactory->GetReferencePhysList("QGSP_BERT_EMZ"); 
physListFactory->GetReferencePhysList("QGSP_BERT_EMZ");
...
/** **/
  ...
  runManager->SetUserInitialization(new B2ActionInitialization(detconst));
  runManager->Initialize();  
  // Initialize visualization
  //
  G4cout << "vismanager initialisation" << G4endl;
